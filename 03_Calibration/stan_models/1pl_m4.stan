...
transformed parameters {
    ...
    beta[:,1] = to_array_1d((mu_pr[1] + sigma[1] * beta_pr) - (mu_pr[2] + sigma[2] * beta_d_pr) - mu_pr[3]);
    beta[:,2] = to_array_1d((mu_pr[1] + sigma[1] * beta_pr) - (mu_pr[2] + sigma[2] * beta_d_pr) + mu_pr[3]);
    beta[:,3] = to_array_1d((mu_pr[1] + sigma[1] * beta_pr) + (mu_pr[2] + sigma[2] * beta_d_pr) - mu_pr[3]);
    beta[:,4] = to_array_1d((mu_pr[1] + sigma[1] * beta_pr) + (mu_pr[2] + sigma[2] * beta_d_pr) + mu_pr[3]);
